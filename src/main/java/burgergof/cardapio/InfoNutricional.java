...
/**
 * <<Flyweight>>
 * Armazena dados estáticos e pesados compartilhados entre
 * milhares de instâncias de Produto — evitando duplicação
 * de memória no horário de pico.
 */
public class InfoNutricional {

    // Estado intrínseco — imutável, compartilhado
    ...
    public String getDescricao()        { return descricaoDetalhada; }
}
