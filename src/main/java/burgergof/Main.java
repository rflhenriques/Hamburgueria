...
import burgergof.atendimento.*;
import burgergof.cardapio.*;
import burgergof.carrinho.*;
import burgergof.cozinha.*;
import burgergof.desconto.*;
import burgergof.interpreter.*;
import burgergof.iterator.*;
import burgergof.model.*;
import burgergof.notificacao.*;
import burgergof.pagamento.*;
import burgergof.visitor.*;
